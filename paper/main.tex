...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig4_tfr_by_country.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig1_tfr_timeline.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig2_tfr_decades.pdf}
  \caption[Decadal TFR]{%
...
Israel is included not as a template for pronatalist policy but as a warning about aggregate statistics. Figure~\ref{fig:contrast} places Israel alongside the US and UK on the same scale; Figure~\ref{fig:israel_groups} then decomposes Israeli fertility by religiosity.

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig5_tfr_contrast.pdf}
...
Israeli TFR declined from the high 3s in the 1960s but stabilised near 3.0 from the 1990s onward (with a modest decline toward 2.9 in the most recent vintages) while US and UK fertility converged near 1.6--1.7. The divergence after 1990 is visually stark in Figure~\ref{fig:contrast}: three high-income jurisdictions with increasingly different demographic outcomes. Secular Jewish women exhibit fertility comparable to other OECD populations; the national aggregate is elevated by religious communities with completed fertility of four or more children \citep{okun2013}. Without Figure~\ref{fig:israel_groups}, the contrast line alone would invite incorrect policy inference.

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig7_israel_groups.pdf}
  \caption[Israel by religiosity]{%
...
\paragraph{Middle East and North Africa.}
...
These regional patterns imply that the mechanisms reviewed in Chapter~\ref{sec:mechanisms} operate with different weights depending on stage of development, policy history, and population composition. Restrictive population policy (China), expansion of contraceptive access (Iran, Bangladesh), and slower structural change (parts of West Africa) represent distinct pathways toward the same broad outcome: lower period fertility.

Figure~\ref{fig:regional_snapshot} compresses the three regional narratives into a single cross-section. East Asia occupies the lower end of the Asia panel; Niger and Nigeria anchor the upper end of the Sub-Saharan panel; MENA spans the middle, with Iran and Turkey at or below replacement and Gulf states such as Saudi Arabia still elevated. The cross-section uses \RegionalYear{} WDI vintages; the high-income bar chart in Figure~\ref{fig:countries} uses \SnapshotYear{}---a deliberate choice to maximise country coverage in each panel, noted again in Chapter~\ref{sec:methods}.

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig10_regional_snapshot.pdf}
...
The three panels make the regional heterogeneity concrete: ultra-low East Asia, mid-transition South Asia and MENA, and still-elevated but declining fertility across much of Sub-Saharan Africa. The rankings are descriptive only; they do not test whether any single mechanism drives the cross-country spread.

The snapshot confirms that ``Asia,'' ``MENA,'' and ``Sub-Saharan Africa'' are not homogeneous blocs. Japan and Korea sit below most European countries; Bangladesh remains above replacement while India has crossed below it in recent vintages; Niger and Nigeria exceed five births per woman while South Africa has transitioned further (TFR near 2.2 in \RegionalYear{} WDI); Kenya and Ethiopia remain higher but are declining from earlier levels. Comparing regional panels to Figure~\ref{fig:countries} situates high-income cases within this wider dispersion: US and UK TFR would appear in the lower-middle of the Asia panel if plotted on the same scale.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig11_regional_trajectories.pdf}
  \caption[Regional TFR trajectories]{%
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/figA_small_multiples.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig3_correlates_timeseries.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig6_intentions_gap.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig8_policy_effects.pdf}
